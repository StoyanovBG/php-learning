...
{ echo '<br>Грешка: '. $conn->error;}
//add line as a comment when using forign key
$conn->close();
/*
//foreign key
$sql3 = "ALTER TABLE deliveryinfo.companyinfo ADD CONSTRAINT FOREIGN KEY ( townid ) 
REFERENCES deliveryinfo.towns ( townid );";

if ($conn->query($sql3) == TRUE) 
{ echo '<br>foreign key е създаден';}
else 
{ echo '<br>Грешка: '. $conn->error;}
$conn->close();
 * 
